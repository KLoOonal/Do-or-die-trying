...
public class GraphicUserInterFaceGz extends JFrame {
	...
	**/
	...
	private JPanel settingBar(){
		...
		((TitledBorder) bar.getBorder()).setTitleJustification(TitledBorder.RIGHT);
	...
	private JPanel settingBar2(){
		...
		((TitledBorder) bar2.getBorder()).setTitleJustification(TitledBorder.RIGHT);
